...
\begin{enumerate}[resume]
  ...
  \item Come to an informed decision, based on progress in \ref{beg}, \ref{cheat}, \ref{alg} and \ref{verify}, along with time constraints, how to proceed -- for example by picking one of:
    \begin{enumerate}
      \item\label{cowardice} A targeted application of \ref{alg} to the new results preferred in \cite{paper-2,2019PhRvD..99f4001L,Lin2}, followed by a continuation of easy, classical investigation to resolve \ref{sr} or \ref{reach}.
