...
\begin{description}
  ...
  \item[Chapter 4] This will be an attempt to further constrain the 33 critical cases of \cite{2019PhRvD..99f4001L,Lin2}, using \ref{al}, \ref{be} or \ref{ga}, but probably \ref{ga}.
...
\subsection{Timeline}
\begin{description}
  \item[15 August 2019] \color{{red}{Hard}}
\end{description}<++>
\end{multicols}
\begin{multicols}{2}
