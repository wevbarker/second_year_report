...
\begin{enumerate}[resume]
  \item Linearised spin projecton operator (SPO) propagator test
  \item The \textit{positive energy test} (PET)
  \item Cauchy-Kovalevska and hyperbolicity conditions
  \item Application of the Dirac algorithm 
\end{enumerate}
...
\begin{enumerate}[resume]
  \item Introduction:
    \begin{enumerate}[resume]
      \item This should have all the usual qualities of an introduction, including a broad literature review adapted from the introductions of \cite{2019JMP....60e2504B,paper-2}.
      \item We will need a clear translation between the PTF and AMF, adapted from \cite{dictionary}.
      \item The 
    \end{enumerate}
  \item Static energetics in gravity
  \item Cosmologically valid gauge gravities: a systematic approach
  \item Nonlinear validity of gauge gravities
\end{enumerate}
\subsection{Timeline}
\end{multicols}
\begin{multicols}{2}
